...
const page = () => {
  return (
    <div className='p-20'>
      <div className='text-red-800 flex justify-start items-start 
      text-7xl mb-10'><h1 className={`${mplus.className}`}>Contact Us</h1></div>
      ...
      <div className=' flex items-start space-x-20 p-4'>
        ...
        <form className='flex flex-col gap-6  w-1/2 '>
          ...
          {/* Button  */}
          <div><button className='py-6 px-12  bg-red-800 text-white 
          border-2 border-red-800 rounded-full text-lg ml-40'>Submit</button></div>
        </form>
